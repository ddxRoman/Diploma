...
<head>
    <meta charset="UTF-8">
    <link rel="icon" type="image" href="../file/icons/Logo/Logo16.png">
...
<body>
    <div class="wrapper">
    <heder class="text-center"><a href="../index.php"><button class="btn btn-outline-secondary mt-3" >Назад</button></a>
        <h1>База знаний</h1></heder>
   ...
   <a href="knowledge/10.html" target="1">  <li>Test</li></a>
   <a href="knowledge/10.html" target="1">  <li>Test</li></a>
   <a href="knowledge/10.html" target="1">  <li>Test</li></a>
   <a href="knowledge/10.html" target="1">  <li>Test</li></a>
   <a href="knowledge/10.html" target="1">  <li>Test</li></a>
